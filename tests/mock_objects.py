...
def iview_noisy_point_list():
    return gazepoint.IView2PointFactory().from_component_list([
...
def iview_points_oob_list():
    ...
    [6400, 0, 6059, 3600, 5398, 3663, 900, 244, 1662, 1789],
    [6417, 0, 6052, 3582, 5406, 3646, 928, 240, 1655, 1757],
    [6434, 0, 5977, 4056, 5403, 3581, 957, 528, 1290,  658],
    [6450, 0, 6052, 3582, 5406, 3646, 536, 240, 1655, 1757],
    [6467, 0, 6058, 3606, 5406, 3669, 537, 245, 1688, 1821],
    [6484, 0, 6059, 3600, 5398, 3663, 535, 244, 1662, 1789],
    [6500, 0, 5977, 4056, 5403, 3581, 470, 528, 1290,  658],
    [6517, 0, 6052, 3582, 5406, 3646, 536, 240, 1655, 1757],
    [6534, 0, 6058, 3606, 5406, 3669, 537, -14, 1688, 1821],
    [6551, 0, 5967, 3976, 5209, 2998, 241, -69, 1473, 693],
    [6567, 0, 5969, 3778, 5404, 3552, 576, -38, 1607, 1141],
...
def iview_scanpath_oob():
    return gazepoint.IViewScanpath(60, iview_points_oob_list(),
        measures=gazepoint.IView2PointFactory().numeric_measures, 
        headers={"calibration_area": (800,600)})
...
def iview_problem_blink():
    ...
    return gazepoint.IViewScanpath(60, f.from_component_list(
        ...
        [6367, 0, 6055, 3608, 5404, 3670, 538, 246, 1717, 1819],
        [6384, 0, 6058, 3606, 5406, 3669, 537, 245, 1688, 1821],
        [6400, 0, 6059, 3600, 5398, 3663, 535, 244, 1662, 1789],
        [6417, 0, 6052, 3582, 5406, 3646, 536, 240, 1655, 1757],
        [6434, 0, 5977, 4056, 5403, 3581, 470, 528, 1290, 658],
        [6450, 0, 0, 0, 0, 0, 0, 0, 0, 0],
        [6467, 0, 2854, 5550, 0, 0, 0, 0, 1166, 1752],
        [6484, 0, 2909, 5563, 0, 0, 0, 0, 1200, 1775],
        [6500, 0, 0, 0, 0, 0, 0, 0, 0, 0],
        [6517, 0, 0, 0, 0, 0, 0, 0, 0, 0],
        [6534, 0, 0, 0, 0, 0, 0, 0, 0, 0],
        [6551, 0, 5967, 3976, 5209, 2998, 241, 354, 1473, 693],
        [6567, 0, 5969, 3778, 5404, 3552, 576, 546, 1607, 1141],
        [6584, 0, 6005, 3661, 5394, 3597, 571, 408, 1727, 1465],
        [6600, 0, 6036, 3576, 5392, 3598, 536, 295, 1725, 1658],
        [6617, 0, 6045, 3558, 5400, 3615, 535, 280, 1689, 1815],
        [6634, 0, 6044, 3544, 5401, 3626, 537, 282, 1690, 1823]]), 
